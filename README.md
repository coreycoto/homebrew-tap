...
the exact single-formula metadata shape and rewrites only that field to the
precreated draft's URL before merging the bottle block. It then uploads both
